...
public class CheckPrimeNumber {
	...
	//This method will accecpt the number and will check whether it's a Prime number or not
	public static void checkIfPrime(int num)
	{
		...
		//If the number is divisible only by 1 and the number itself then the Count will be 2 and will consider as Prime		
		if(count==2)
		{
			System.out.println("The number: " + num +" is a Prime number");
		}
		
		// If the number is divisible by more than 2 numbers then it's not a Prime number
		else
		{
